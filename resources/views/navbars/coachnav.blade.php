            ...
            <ul class="navbar-nav mr-auto">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="{{route('createProject')}}">Create a Project</a>
                        <a class="dropdown-item" href="{{route('viewProjects')}}">Assign a Project</a>
                        </div>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Teams</a>
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="{{route('createTeamView')}}">Create a Team</a>
                        <a class="dropdown-item" href="{{route('viewTeams')}}">View Teams</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="{{route('createQuestionnaire')}}">Create a Questionnaire</a>
                        <a class="dropdown-item" href="{{route('showAll')}}">View Questionnaires</a>
                    </div>
                </li>
            </ul>
